...
function defaultFixtureMarkup(id, selector, slots) {
  ...
  if (id === 'marquee') return `<section ${root} aria-label="Capabilities"><div data-motion-marquee-track><span>Semantic hooks · Reduced motion · Cleanup · </span><span aria-hidden="true">Semantic hooks · Reduced motion · Cleanup · </span></div></section>`
